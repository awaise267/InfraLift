...
exports.approve = function(req,res){
	...
	var SQL_Query = "call approve_posts("+REQUEST_ID+")";
...
exports.addcontact = function(req,res){	
	...
	var SQL_Query = "call insert_mailing_list("+ZIPCODE+","+EMAIL_ID+","+STATE+","+COUNTRY+")" ;
	...
	mysql.executeQuery(function(err,results){
		...
		{
			console.log("insert_mailing_list ");
			console.log(results);
			if(results.affectedRows == 1){	
...
exports.afterSignIn = function (req,res){
	...
	var getUser="call login_admin("+inputUsername+","+inputPassword+")";
